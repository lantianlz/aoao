...
urlpatterns = patterns('www.shop.views',
                       url(r'^$', 'shop_index'),
                       url(r'^(?P<car_wash_id>\d+)/verify_code$', 'verify_code', {'template_name': 'pc/shop/verify_code.html'}),
                       url(r'^(?P<car_wash_id>\d+)/shop_cash$', 'shop_cash', {'template_name': 'pc/shop/shop_cash.html'}),
